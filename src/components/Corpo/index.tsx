...
function Carta() {
    return (
        <div className="space-y-6">
            ...
            <a
                href={cvPdf}
                download="Curriculo-GuilhermeDomingues.pdf"
...
function MapaCarreira() {
    const prox_etapas = [
        ...
        },
        {
            ...
            periodo: "Futuro",
            descricao: "Aprimorando conhecimentos em backend, bancos de dados e arquitetura de sistemas, com foco em integração e entrega contínua.",
            skills: ["Java", "Node.js", "PostgreSQL", "MongoDB", "React", "TypeScript", "Git", "AI/ML"],
            status: "futuro"
        },
...
function HardSkills() {
    ...
    const outras = [
        "Git/GitHub", "Bash", "Powershell", "Figma","Photoshop",
        "npm", "Excel", "Word", "Sheets", "Docs", "Trello", "Infraestrutura de TI",
        "Suporte Técnico", "Rede de Computadores"
    ]
