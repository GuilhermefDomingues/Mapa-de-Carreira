import foto from "../../assets/foto-gui.jpeg"
    ...
    return (
        <div className="flex-shrink-0">
            <img
                ...
                alt="perfil do Guilherme França Domingues"
            />
        </div>
    )
}
        ...
        <div className="flex flex-col gap-8 flex-1">
            ...
            <div className="space-y-3">
                <div className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
                    ...
                    <span className="text-sm">Guilhermefrancadomingues@outlook.com</span>
                </div>

                <a
                    href="https://www.linkedin.com/in/guilherme-fran%C3%A7a-domingues-84a070276/"
                    target="_blank"
                ...
                >
                    ...
                    <span className="text-sm">Guilherme França Domingues</span>
                </a>

                <a
                    href="https://github.com/GuilhermefDomingues"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                >
                    ...
                    <span className="text-sm">GuilhermefDomingues</span>
                </a>
            </div>
        </div>
    )
